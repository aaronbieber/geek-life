...
const (
	...
	ActionWordStartRight         = "WordStartRight"
	ActionWordStartLeft          = "WordStartLeft"
...
var bindingActions = map[string]func(*View) bool{
	...
	ActionWordStartRight:         (*View).WordStartRight,
	ActionWordStartLeft:          (*View).WordStartLeft,
...
func init() {
	DefaultKeyBindings = NewKeyBindings(map[string]string{
		...
		"CtrlLeft":       ActionWordStartLeft,
		"CtrlRight":      ActionWordStartRight,
		...
		// Ctrl+Backspace (which most terminals send as Ctrl+H / 0x08) and Ctrl+W
		// delete the previous word. Plain Backspace is KeyBackspace2 (0x7f), so
		// it still deletes a single character.
		"CtrlH":         ActionDeleteWordLeft,
		"CtrlW":         ActionDeleteWordLeft,
