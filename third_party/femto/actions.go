...
// WordStartLeft collapses any selection and moves the cursor to the beginning of
// the previous word (its first character).
func (v *View) WordStartLeft() bool {
	v.deselect(0)
	v.Cursor.WordLeft()
	return true
}

// WordStartRight collapses any selection and moves the cursor to the beginning
// of the next word (its first character).
func (v *View) WordStartRight() bool {
	v.deselect(0)
	v.Cursor.WordStartRight()
	return true
}
